...
document.documentElement.focus(); /* fix for ie9 not loading proper */
...
$(document).ready(function () {
    ...
    $("#Track_submit").click(function () {
        ...
        if (((firstName != "") && (lastName != "")) && ((!firstName.match(/^[a-zA-Z\s]*$/))) && ((recv_firstName == "") || (recv_lastName == ""))) {
        ...
        if (((firstName != "") && (lastName != "")) && ((!lastName.match(/^[a-zA-Z\s]*$/))) && ((recv_firstName == "") || (recv_lastName == ""))) {
        ...
        if (((recv_firstName != "") && (recv_lastName != "")) && ((!recv_firstName.match(/^[a-zA-Z\s]*$/))) && ((firstName == "") || (lastName == ""))) {
        ...
        if (((recv_firstName != "") && (recv_lastName != "")) && ((!recv_lastName.match(/^[a-zA-Z\s]*$/))) && ((firstName == "") || (lastName == ""))) {
        ...
        if ((recv_firstName != "") && (!recv_firstName.match(/^[a-zA-Z\s]*$/))) {
            submit_t = false;

        }
        if ((recv_lastName != "") && (!recv_lastName.match(/^[a-zA-Z\s]*$/))) {
            submit_t = false;
...
$(document).ready(function () {
    ...
    $("#desktopOnly a.current").text($("#homeForm a.current").text());
    ...
    if($(window).width() < 747) {
		...
		$("#desktopOnly").empty();
        var seleVal = $("#preferredCountry").val();
        var seleCountry = $('.country_links #preferredCountry option[value='+ seleVal +']').text();
        $('.country_links ul li').each(function(index){
            $(this).removeClass();
            if($(this).text() === seleCountry){
        ...
        $("#preferredCountry").val($('#defaultcountry').val().toLowerCase());
        $("#countryCode").val($('#preferredCountry').val());
        if(!$("#desktopOnly .language-bar").length){
		$("#desktopOnly").html('<input type="hidden" name="queryPath" id="queryPath" value="/content/wucom/Countries/en_AF/utils/countrylangboilerplate/jcr:content/parCentre/countrylangdropdown"><input type="hidden" name="defaultlanguage" id="defaultlanguage" value="en"><input type="hidden" name="currResource" id="currResource" value="/content/wucom/Countries/en_AF/utils/countrylangboilerplate/jcr:content/parCentre/countrylangdropdown"><div class="language-bar"><!--  countrylangboilerplate page UI issue --><form autocomplete="off" action="http://www.westernunion.com/WUCOMWEB/selectCountry.do" method="GET" name="countryLanguageHeaderForm" id="countryLanguageHeaderForm" class="menudropdown custom app_form"> <!--  countrylangboilerplate page UI issue class=custom--><input type="hidden" name="method" value="load"><input type="hidden" name="countryCode" id="countryCode" value="" class="hasPlaceholder"><input type="hidden" name="languageCode" id="languageCode" value="" class="hasPlaceholder"><select name="country" class="changeCountry app_select hidden-field" id="preferredCountry" data-id="1378408867075-STWeq"><option value="af">Afghanistan</option><option value="al">Albania</option><option value="dz">Algeria</option><option value="as">American Samoa</option><option value="ao">Angola</option><option value="ai">Anguilla</option><option value="ag">Antigua and Barbuda</option><option value="ar">Argentina</option><option value="am">Armenia</option><option value="aw">Aruba</option><option value="au">Australia</option><option value="at">Austria</option><option value="az">Azerbaijan</option><option value="bs">Bahamas</option><option value="bh">Bahrain</option><option value="bd">Bangladesh</option><option value="bb">Barbados</option><option value="by">Belarus</option><option value="be">Belgium</option><option value="bz">Belize</option><option value="bj">Benin</option><option value="bm">Bermuda</option><option value="bt">Bhutan</option><option value="bo">Bolivia</option><option value="ba">Bosnia &amp; Herzegovina</option><option value="bw">Botswana</option><option value="br">Brazil</option><option value="vg">British Virgin Islands</option><option value="bn">Brunei Darussalam</option><option value="bg">Bulgaria</option><option value="bf">Burkina Faso</option><option value="bi">Burundi</option><option value="kh">Cambodia</option><option value="cm">Cameroon</option><option value="ca">Canada</option><option value="cv">Cape Verde</option><option value="cf">Central African Republic</option><option value="td">Chad</option><option value="cl">Chile</option><option value="cn">China</option><option value="co">Colombia</option><option value="km">Comoros</option><option value="cg">Congo</option><option value="ck">Cook Islands</option><option value="cr">Costa Rica</option><option value="ci">Cote dIvoire</option><option value="hr">Croatia</option><option value="cu">Cuba</option><option value="c1">Curacao</option><option value="cy">Cyprus</option><option value="c2">Cyprus (Northern)</option><option value="cz">Czech Republic</option><option value="cd">Dem Rep of Congo</option><option value="dk">Denmark</option><option value="dj">Djibouti</option><option value="dm">Dominica</option><option value="do">Dominican Republic</option><option value="tp">East Timor</option><option value="ec">Ecuador</option><option value="eg">Egypt</option><option value="sv">El Salvador</option><option value="gq">Equatorial Guinea</option><option value="er">Eritrea</option><option value="ee">Estonia</option><option value="et">Ethiopia</option><option value="fk">Falkland Islands</option><option value="fj">Fiji</option><option value="fi">Finland</option><option value="fr">France</option><option value="gf">French Guiana</option><option value="pf">French Polynesia</option><option value="ga">Gabon</option><option value="gm">Gambia</option><option value="ge">Georgia</option><option value="de">Germany</option><option value="gh">Ghana</option><option value="gi">Gibraltar</option><option value="gr">Greece</option><option value="gd">Grenada</option><option value="gp">Guadeloupe</option><option value="gu">Guam</option><option value="gt">Guatemala</option><option value="gn">Guinea</option><option value="gw">Guinea-Bissau</option><option value="gy">Guyana</option><option value="ht">Haiti</option><option value="hn">Honduras</option><option value="hk">Hong Kong</option><option value="hu">Hungary</option><option value="is">Iceland</option><option value="in">India</option><option value="id">Indonesia</option><option value="iq">Iraq</option><option value="ie">Ireland</option><option value="il">Israel</option><option value="it">Italy</option><option value="jm">Jamaica</option><option value="jp">Japan</option><option value="jo">Jordan</option><option value="kz">Kazakhstan</option><option value="ke">Kenya</option><option value="ki">Kiribati</option><option value="kr">Korea</option><option value="k1">Kosovo</option><option value="kw">Kuwait</option><option value="kg">Kyrghyz Republic</option><option value="la">Laos</option><option value="lv">Latvia</option><option value="lb">Lebanon</option><option value="lr">Liberia</option><option value="ly">Libya</option><option value="li">Liechtenstein</option><option value="lt">Lithuania</option><option value="lu">Luxembourg</option><option value="mo">Macau</option><option value="mk">Macedonia</option><option value="mg">Madagascar</option><option value="mw">Malawi</option><option value="my">Malaysia</option><option value="mv">Maldives</option><option value="ml">Mali</option><option value="mt">Malta</option><option value="mh">Marshall Islands</option><option value="mq">Martinique</option><option value="mr">Mauritania</option><option value="mu">Mauritius</option><option value="yt">Mayotte</option><option value="mx">Mexico</option><option value="fm">Micronesia</option><option value="md">Moldova</option><option value="mc">Monaco</option><option value="mn">Mongolia</option><option value="me">Montenegro</option><option value="ms">Montserrat</option><option value="ma">Morocco</option><option value="mz">Mozambique</option><option value="np">Nepal</option><option value="nl">Netherlands</option><option value="nc">New Caledonia</option><option value="nz">New Zealand</option><option value="ni">Nicaragua</option><option value="ne">Niger</option><option value="ng">Nigeria</option><option value="nu">Niue</option><option value="mp">Northern Mariana Islands</option><option value="no">Norway</option><option value="om">Oman</option><option value="pk">Pakistan</option><option value="pw">Palau</option><option value="p1">Palestinian Authority</option><option value="pa">Panama</option><option value="pg">Papua New Guinea</option><option value="py">Paraguay</option><option value="pe">Peru</option><option value="ph">Philippines</option><option value="pl">Poland</option><option value="pt">Portugal</option><option value="pr">Puerto Rico</option><option value="qa">Qatar</option><option value="nr">Republic of Nauru</option><option value="re">Reunion</option><option value="ro">Romania</option><option value="ru">Russia</option><option value="rw">Rwanda</option><option value="kn">Saint Kitts and Nevis</option><option value="lc">Saint Lucia</option><option value="mf">Saint Martin</option><option value="vc">Saint Vincent and the Grenadines</option><option value="ws">Samoa</option><option value="sa">Saudi Arabia</option><option value="sn">Senegal</option><option value="sl">Sierra Leone</option><option value="sg">Singapore</option><option value="sk">Slovakia</option><option value="si">Slovenia</option><option value="sb">Solomon Islands</option><option value="za">South Africa</option><option value="es">Spain</option><option value="lk">Sri Lanka</option><option value="sd">Sudan</option><option value="sr">Suriname</option><option value="se">Sweden</option><option value="ch">Switzerland</option><option value="sy">Syria</option><option value="st">SÃ£o TomÃ© and PrÃ­ncipe</option><option value="tw">Taiwan</option><option value="tj">Tajikistan</option><option value="tz">Tanzania</option><option value="th">Thailand</option><option value="tg">Togo</option><option value="to">Tonga</option><option value="tt">Trinidad &amp; Tobago</option><option value="tn">Tunisia</option><option value="tr">Turkey</option><option value="tm">Turkmenistan</option><option value="tc">Turks and Caicos Islands</option><option value="tv">Tuvalu</option><option value="ug">Uganda</option><option value="ua">Ukraine</option><option value="ae">United Arab Emirates</option><option value="gb">United Kingdom</option><option value="us">United States</option><option value="vi">United States Virgin Islands</option><option value="uy">Uruguay</option><option value="uz">Uzbekistan</option><option value="vu">Vanuatu</option><option value="ve">Venezuela</option><option value="vn">Vietnam</option><option value="ye">Yemen</option><option value="zm">Zambia</option><option value="zw">Zimbabwe</option></select><div class="custom dropdown changeCountry app_select" data-id="1378408867075-STWeq"><a href="#" class="current">Afghanistan</a><a href="#" class="selector"></a><ul><li>Afghanistan</li><li>Albania</li><li>Algeria</li><li>American Samoa</li><li>Angola</li><li>Anguilla</li><li>Antigua and Barbuda</li><li>Argentina</li><li>Armenia</li><li>Aruba</li><li>Australia</li><li>Austria</li><li>Azerbaijan</li><li>Bahamas</li><li>Bahrain</li><li>Bangladesh</li><li>Barbados</li><li>Belarus</li><li>Belgium</li><li>Belize</li><li>Benin</li><li>Bermuda</li><li>Bhutan</li><li>Bolivia</li><li>Bosnia &amp; Herzegovina</li><li>Botswana</li><li>Brazil</li><li>British Virgin Islands</li><li>Brunei Darussalam</li><li>Bulgaria</li><li>Burkina Faso</li><li>Burundi</li><li>Cambodia</li><li>Cameroon</li><li>Canada</li><li>Cape Verde</li><li>Central African Republic</li><li>Chad</li><li>Chile</li><li>China</li><li>Colombia</li><li>Comoros</li><li>Congo</li><li>Cook Islands</li><li>Costa Rica</li><li>Cote dIvoire</li><li>Croatia</li><li>Cuba</li><li>Curacao</li><li>Cyprus</li><li>Cyprus (Northern)</li><li>Czech Republic</li><li>Dem Rep of Congo</li><li>Denmark</li><li>Djibouti</li><li>Dominica</li><li>Dominican Republic</li><li>East Timor</li><li>Ecuador</li><li>Egypt</li><li>El Salvador</li><li>Equatorial Guinea</li><li>Eritrea</li><li>Estonia</li><li>Ethiopia</li><li>Falkland Islands</li><li>Fiji</li><li>Finland</li><li>France</li><li>French Guiana</li><li>French Polynesia</li><li>Gabon</li><li>Gambia</li><li>Georgia</li><li>Germany</li><li>Ghana</li><li>Gibraltar</li><li>Greece</li><li>Grenada</li><li>Guadeloupe</li><li>Guam</li><li>Guatemala</li><li>Guinea</li><li>Guinea-Bissau</li><li>Guyana</li><li>Haiti</li><li>Honduras</li><li>Hong Kong</li><li>Hungary</li><li>Iceland</li><li>India</li><li>Indonesia</li><li>Iraq</li><li>Ireland</li><li>Israel</li><li>Italy</li><li>Jamaica</li><li>Japan</li><li>Jordan</li><li>Kazakhstan</li><li>Kenya</li><li>Kiribati</li><li>Korea</li><li>Kosovo</li><li>Kuwait</li><li>Kyrghyz Republic</li><li>Laos</li><li>Latvia</li><li>Lebanon</li><li>Liberia</li><li>Libya</li><li>Liechtenstein</li><li>Lithuania</li><li>Luxembourg</li><li>Macau</li><li>Macedonia</li><li>Madagascar</li><li>Malawi</li><li>Malaysia</li><li>Maldives</li><li>Mali</li><li>Malta</li><li>Marshall Islands</li><li>Martinique</li><li>Mauritania</li><li>Mauritius</li><li>Mayotte</li><li>Mexico</li><li>Micronesia</li><li>Moldova</li><li>Monaco</li><li>Mongolia</li><li>Montenegro</li><li>Montserrat</li><li>Morocco</li><li>Mozambique</li><li>Nepal</li><li>Netherlands</li><li>New Caledonia</li><li>New Zealand</li><li>Nicaragua</li><li>Niger</li><li>Nigeria</li><li>Niue</li><li>Northern Mariana Islands</li><li>Norway</li><li>Oman</li><li>Pakistan</li><li>Palau</li><li>Palestinian Authority</li><li>Panama</li><li>Papua New Guinea</li><li>Paraguay</li><li>Peru</li><li>Philippines</li><li>Poland</li><li>Portugal</li><li>Puerto Rico</li><li>Qatar</li><li>Republic of Nauru</li><li>Reunion</li><li>Romania</li><li>Russia</li><li>Rwanda</li><li>Saint Kitts and Nevis</li><li>Saint Lucia</li><li>Saint Martin</li><li>Saint Vincent and the Grenadines</li><li>Samoa</li><li>Saudi Arabia</li><li>Senegal</li><li>Sierra Leone</li><li>Singapore</li><li>Slovakia</li><li>Slovenia</li><li>Solomon Islands</li><li>South Africa</li><li>Spain</li><li>Sri Lanka</li><li>Sudan</li><li>Suriname</li><li>Sweden</li><li>Switzerland</li><li>Syria</li><li>SÃ£o TomÃ© and PrÃ­ncipe</li><li>Taiwan</li><li>Tajikistan</li><li>Tanzania</li><li>Thailand</li><li>Togo</li><li>Tonga</li><li>Trinidad &amp; Tobago</li><li>Tunisia</li><li>Turkey</li><li>Turkmenistan</li><li>Turks and Caicos Islands</li><li>Tuvalu</li><li>Uganda</li><li>Ukraine</li><li>United Arab Emirates</li><li>United Kingdom</li><li>United States</li><li>United States Virgin Islands</li><li>Uruguay</li><li>Uzbekistan</li><li>Vanuatu</li><li>Venezuela</li><li>Vietnam</li><li>Yemen</li><li>Zambia</li><li>Zimbabwe</li></ul></div><input type="hidden" name="onelanguageCode" id="onelanguageCode" value="en"></form></div><!--  countrylangboilerplate page UI issue -->');
...
/* country language drop down redirection start */
    ...
    $(document).on("change","#preferredCountry, #preferredLanguage", function(){
      changeCountryDropDown();//PBL-1769
    });
    //PBL-1769 Start
     $(document).on("click", ".dropdown ul li", function(){
      var getCountryName=this.innerHTML;
      var value='';
      var language='';
    ...
    case 'English': 
      ...
      if(currentCountry == "RU" || currentCountry == "UA"){ 
    ...
    //PBL-1848 Start
    if(value||language){
    changeCountryDropDown(value,language);
  }//PBL-1848 End
      });
     //PBL-1769 End
...
//PBL-1769 Start
 function changeCountryDropDown(countryVal,language){
    $("#countryCode").val(countryVal);
    
    if(language!=null && language!==''){
       $("#languageCode").val(language);
    }
    else if($('#preferredLanguage').val() != null){
    ...
    setCookie("WUCountryCookie_",country,90,"wu.com");
    setCookie("WULanguageCookie_",language,90,"wu.com");
...
$(window).resize(function(){
    ...
    if($("#homeForm").length !== 0){
		$("#desktopOnly a.current").text($("#homeForm a.current").text());
        $(".country_links a.current").text($("#homeForm a.current").text());
        var seleVal = $("#preferredCountry").val();
        var seleCountry = $('#desktopOnly #preferredCountry option[value='+ seleVal +']').text();
        $('#desktopOnly ul li').each(function(index){
            $(this).removeClass();
            if($(this).text() === seleCountry){
		...
		var seleVal = $("#preferredCountry").val();
    $("#desktopOnly .countrydropdown-wrapper a.current").text($('#desktopOnly #preferredCountry option[value='+ seleVal +']').text());
        $(".country_links .countrydropdown-wrapper a.current").text($('.country_links #preferredCountry option[value='+ seleVal +']').text());
          //var seleVal = $("#preferredCountry").val();
        var seleCountry = $('#desktopOnly #preferredCountry option[value='+ seleVal +']').text();
        $('#desktopOnly .countrydropdown-wrapper ul li').each(function(index){
            $(this).removeClass();
            if($(this).text() === seleCountry){
        ...
        //settings for language dropd down
        var seleValLang = $("#preferredLanguage").val();

        if($("#desktopOnly .languagedropdown-wrapper div a.current").parent().html() !== undefined ) {
      $("#desktopOnly .languagedropdown-wrapper div a.current").text($('#desktopOnly #preferredLanguage option[value='+ seleValLang +']').text());
        }
        $(".country_links .languagedropdown-wrapper a.current").text($('.country_links #preferredLangauge option[value='+ seleValLang +']').text());

        var seleLanguage = $('#desktopOnly #preferredLangauge option[value='+ seleVal +']').text();
        $('#desktopOnly .languagedropdown-wrapper ul li').each(function(index){
            $(this).removeClass();
            if($(this).text() === seleLanguage){
...
//Modify ServerName based on platform R2 for R3 static pages and R3 for all R3 pages				
	...
	if (document.referrer !=null && document.referrer != ""){
    	...
    	try{
	//alert('Hi');
	//var url =  location.protocol+"//" + location.host +'/WURedirectorService/rest/redirectorcall';
                        ...
                        if (jsonObject["action"] == 'EXECUTION') {	
							...
							if ( document.referrer !=null && document.referrer != "" && isSameDomain != "yes"  )
							{
								...
								throttlingQueryParam = getParamFromKey(destination,"tid");
									...
									if(throttlingQueryParam.length > 0){
                           ...
                           console.log("destinationurl="+destination);
							...
							document.cookie = "SERVER_COOKIE=R2" + expires
									+ "; path=/";
						}
					}
				}
...
;(function ($, window, document, undefined) {
  ...
  Foundation.libs.forms = {
    ...
    events : function () {
      ...
      $(document).on('keydown', function (e) {
        var focus = document.activeElement,
          ...
          var getKey = e.charCode ? e.charCode : e.keyCode ? e.keyCode : 0;
		  var splitChar="";
        ...
        if (dropdown.length > 0) {
          ...
          if (e.which >= 65 && e.which <= 90) {
			   ...
			   var findSearch = String.fromCharCode(e.charCode || e.keyCode).toLowerCase();

				if(typeSearch !="" && typeSearch.length ==1 && findSearch == typeSearch) {
					typeSearch = String.fromCharCode(e.charCode || e.keyCode).toLowerCase();
					singleSearch = true;
				} else {
					typeSearch += String.fromCharCode(e.charCode || e.keyCode).toLowerCase();
					singleSearch = false;
               ...
               self.go_to_multi_search(dropdown, e,typeSearch,typeTimer,singleSearch);
          ...
          if (e.which === 38) {
            ...
            if (prev.length > 0) {
			  ...
			  self.scrollTo(prev.addClass('selected'), 300);
            }
          } else if (e.which === 40) {
            var current = dropdown.find('li.selected'),
	...
	check_existence: function(dropdown,searchStr) {
		 var lis = dropdown.find('li');
		 var textExists = false;
		 $(lis).each(function () {
			if ($(this).text().substr(0, searchStr.length).toLowerCase() === searchStr.toLowerCase()) {
				textExists = true;
			}				
		});
		return textExists;
	},
    go_to_multi_search : function(dropdown,e,typeSearch,typeTimer,singleSearch) {			  			 

          	  var lis = dropdown.find('li');
              var current = dropdown.find('li.selected');
			  var self = Foundation.libs.forms;
			  var findSearch = String.fromCharCode(e.charCode || e.keyCode);
			  var nextSearch = current.next(':not(.disabled)');

			   if($(current).text().substr(0,1) == findSearch) {
					typeSearch = findSearch;
					singleSearch = true;					
			  } 	
			  
			  if(self.check_existence(dropdown,typeSearch)) {
				 $(lis).each(function () {
					if ($(this).text().substr(0, typeSearch.length).toLowerCase() === typeSearch.toLowerCase()) {
                        		current.removeClass('selected');								
								if(singleSearch) {	
									if(findSearch == nextSearch.text().substr(0,1)) {
										self.scrollTo(nextSearch.addClass('selected'), 300);
									}  else {
										self.scrollTo($(this).addClass('selected'), 300);
									}	
								} else {
									self.scrollTo($(this).addClass('selected'), 300);
								}  
				  ...
				  $(lis).each(function () {
					if ($(this).text().substr(0, findSearch.length).toLowerCase() === findSearch.toLowerCase()) {
								current.removeClass('selected');
								self.scrollTo($(this).addClass('selected'), 300);
								return false;
					}
    ...
    go_to : function (dropdown, char) {
      ...
      if (count > 0) {
        for (var i=0; i < count; i++) {
          var first_letter = lis.eq(i).text().charAt(0);
          if (first_letter.toLowerCase() === String.fromCharCode(char).toLowerCase()) 
            return lis.eq(i);
        }
      }
    },
    ...
    scrollTo : function (el, duration) {
     ...
     // console.log((li_height*(el.index()+1)))
      //var difference = (li_height*(el.index()+1) - li_height) - parent.scrollTop();
	  var difference = (li_height*(el.index()+0) - li_height) - parent.scrollTop();
      var perTick = difference / duration * 10;
	  ...
	  var scrollBox = el.parent(),
	  top = parseInt(el.offset().top - scrollBox.position().top),
      bottom = parseInt(top + el.outerHeight());			
				
		if (center) {
			scrollBox.scrollTop(el.offset().top - scrollBox.offset().top + scrollBox.scrollTop() - (scrollBox.height() / 10))
		} else {
			if (top < 0) {
				scrollBox.scrollTop(el.offset().top - scrollBox.offset().top + scrollBox.scrollTop())
			}
			if (bottom > scrollBox.height()) {
				scrollBox.scrollTop((el.offset().top + el.outerHeight()) - scrollBox.offset().top + scrollBox.scrollTop() - scrollBox.height())
			}
		}
  ...
  Foundation.libs.orbit = {
    ...
    _init: function (idx, slider) {
      ...
      $.extend(true, self.settings, self.data_options($slides_container));
                  ...
                  // Start - Fix to avoid looping for one image //
                  if($slides.length > 1) {
      // End - Fix to avoid looping for one image //
